...
<head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('assest/admin/fonts/ionicons/2.0.1/css/ionicons.min.css') }}">
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('assest/admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('assest/admin/dist/css/adminlte.min.css') }}">
    <!-- Google Font: Source Sans Pro -->
    <link href="{{ asset('assest/admin/fonts/SansPro/SansPro.min.css') }}" rel="stylesheet">

        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center" style="font-weight: bold">بيانات الموظفين</h3>
                    <input type="hidden" id="token_search" value="{{ csrf_token() }}">
                    <input type="hidden" id="ajax_search_url" value="{{ route('admin.employees.ajax_search') }}">
                                    ...
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.employees.show',$info->id) }}" class="btn btn-sm btn-info">

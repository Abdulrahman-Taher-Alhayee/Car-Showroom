                    ...
                    @if (@isset($data) && !@empty($data))
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="image">
                                        <img src="{{ asset('assest/admin/uploads').'/'. $data['photo'] }}" alt="لوجو الشركة" class="custom_img">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    لا يوجد تحديث
                                    @endif
                                    <a href="{{ route('admin.adminpanalsetting.edit') }}" class="btn btn-sm btn-success">تعديل</a>
                                </td>
                            </tr>
                        </table>
                    @else
